...
@Component({
  ...
  template: `
    <div class="relative h-full w-full">
      <video class="w-32 absolute right-5 top-4 h-52 object-cover border-e-red-500 border-2 rounded-lg"
      #localVideo autoplay playsInline></video>
      <video class="w-full h-full right-5 object-cover bg-slate-800"
...
export class VideoChatComponent {
  ...
  async startLocalVideo() {
   ...
   /* if (!this.localVideo) {
    console.error("localVideo non initialisé !");
    return;
  }*/
